...
public class ContactCreationTests {
    ...
    public void testContactCreation() {
        ...
        initContactCreation();
        fillContactForm(new ContactData("Firstname", "Midname", "Lastname", "Addr", "1111", "2222", "3333", "email1@aaa.aa", "email2@bbb.bb", "email3@ccc.cc", "5555"));
    ...
    private void fillContactForm(ContactData contactData) {
        ...
        wd.findElement(By.name("home")).sendKeys(contactData.getFirstHomePhone());
